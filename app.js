...
//post request of compose page
app.post("/compose",function(req,res){
  //creating an object of textarea and input field
  //name as postBody and postTitle
var post={
...
//express routing parameter used 
...
//get request of main local route
app.get(port,function(req,res)
{
  res.render("Local Host is running at 3000");
})
